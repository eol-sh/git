/**
 * @fileoverview Git write-commit API - High-level user interface
 *
 * This module provides the public API for write-commit operations in the Git implementation.
 * It handles parameter validation, file system adaptation, and error handling.
 *
 * @module api/write-commit.ts
 * @version 1.0.0
