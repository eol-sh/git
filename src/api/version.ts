/**
 * @fileoverview Git version API - High-level user interface
 *
 * This module provides the public API for version operations in the Git implementation.
 * It handles parameter validation, file system adaptation, and error handling.
 *
 * @module api/version.ts
 * @version 1.0.0
