/**
 * @fileoverview Git reset-index API - High-level user interface
 *
 * This module provides the public API for reset-index operations in the Git implementation.
 * It handles parameter validation, file system adaptation, and error handling.
 *
 * @module api/reset-index.ts
 * @version 1.0.0
