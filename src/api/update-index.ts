/**
 * @fileoverview Git update-index API - High-level user interface
 *
 * This module provides the public API for update-index operations in the Git implementation.
 * It handles parameter validation, file system adaptation, and error handling.
 *
 * @module api/update-index.ts
 * @version 1.0.0
