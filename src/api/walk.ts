/**
 * @fileoverview Git walk API - High-level user interface
 *
 * This module provides the public API for walk operations in the Git implementation.
 ...
 *
 * ```js
 * import { STAGE, TREE, WORKDIR } from "@eol/git.ts";
 * ```
 *
