/**
 * @fileoverview Git list-files API - High-level user interface
 *
 * This module provides the public API for list-files operations in the Git implementation.
 * It handles parameter validation, file system adaptation, and error handling.
 *
 * @module api/list-files.ts
 * @version 1.0.0
