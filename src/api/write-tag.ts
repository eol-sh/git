/**
 * @fileoverview Git write-tag API - High-level user interface
 *
 * This module provides the public API for write-tag operations in the Git implementation.
 * It handles parameter validation, file system adaptation, and error handling.
 *
 * @module api/write-tag.ts
 * @version 1.0.0
