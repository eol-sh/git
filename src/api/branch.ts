/**
 * @fileoverview Git branch API - High-level user interface
 *
 * This module provides the public API for branch operations in the Git implementation.
 * It handles parameter validation, file system adaptation, and error handling.
 *
 * @module api/branch.ts
 * @version 1.0.0
