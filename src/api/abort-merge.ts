/**
 * @fileoverview Git abort-merge API - High-level user interface
 *
 * This module provides the public API for abort-merge operations in the Git implementation.
 * It handles parameter validation, file system adaptation, and error handling.
 *
 * @module api/abort-merge.ts
 * @version 1.0.0
