/**
 * @fileoverview Git delete-ref API - High-level user interface
 *
 * This module provides the public API for delete-ref operations in the Git implementation.
 * It handles parameter validation, file system adaptation, and error handling.
 *
 * @module api/delete-ref.ts
 * @version 1.0.0
